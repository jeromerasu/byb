...
public class WorkoutService {
    ...
    public Mono<Map<String, Object>> generateWorkoutPlan(String userId) {
        return Mono.fromCallable(() -> {
            ...
            try {
                objectStorageService.storeWorkoutPlan(userId, planTitle, workoutPlan);
    ...
    public Mono<Map<String, Object>> getCurrentWorkoutPlan(String userId) {
        return Mono.fromCallable(() -> {
            ...
            try {
                Map<String, Object> plan = objectStorageService.retrieveWorkoutPlan(userId, profile.getCurrentPlanStorageKey());
